  ...
  return (
    <div className="marginT container-fluid">
      ...
      <div className="col-sm-10">
        ...
        <ul className="tabRight">
          <li className="fontS23H20 marginB">Pull client data earmarked for my firm down automatically into our CRM when no API is available. (ex: Supplier Portal)</li>
          <li className="fontS23H20 marginB">Pull contact data for someone into your CRM (ex: LinkedIn)</li>
          <li className="fontS23H20 marginB">Pull job data earmarked for me down automatically when no API is available. (ex: StackOverflow Jobs)</li>
        </ul>
      </div>
    </div>
    </div>
